...
def main(args):
    ...
    inspect_preprocessor.segment_studies(
        save_to=args.output_path, start=args.start, end=args.end
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--start", default=0, type=int, help="Starting point Relative to dataset size"
    )
    parser.add_argument(
        "--end", default=-1, type=int, help="Ending point Relative to dataset size"
    )
    parser.add_argument(
